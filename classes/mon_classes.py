...
#import warnings 
#import numpy
from classes.frag_classes import IDT, CPDT, DPP, BT, PT, FBT, thiophene, pyridine, TPD,BDT
from classes.r_classes import c11_bo,HD,ODD,C1BO,C3BO,C4BO,C5BO, C16, ene_HD, ene_ODD
