...
mbuild_to_foyer_xml(
    file_name="/Users/madilyn/Projects/repos/forcefields/xml_files/Y6.xml", #change this to whatever you want to save your xml file as
    compound=mol2comp,
...
mol2comp.save("/Users/madilyn/Projects/repos/forcefields/mol2files/y6_typed.mol2", overwrite=True)
